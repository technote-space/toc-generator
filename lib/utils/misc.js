...
const { getWorkspace, getArrayInput, getPrefixRegExp, getBranch, getBoolValue } = github_action_helper_1.Utils;
...
const getBranchPrefixRegExp = () => getPrefixRegExp(getBranchPrefix());

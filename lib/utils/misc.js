...
exports.isTargetEvent = (context) => isTargetRef(context) && 'string' === typeof context.payload.action && context.eventName in constant_1.TARGET_EVENTS && (constant_1.TARGET_EVENTS[context.eventName] === context.payload.action || '*' === constant_1.TARGET_EVENTS[context.eventName]);
...
exports.getDocTocArgs = () => getTargetPaths().join(' ');

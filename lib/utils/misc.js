...
const { getWorkspace, getArrayInput, escapeRegExp, getBranch, getBoolValue, isPr } = github_action_helper_1.Utils;
...
exports.isCreatePR = (context) => isPr(context) && !!core_1.getInput('PR_BRANCH_NAME');

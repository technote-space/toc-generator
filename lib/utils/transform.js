...
exports.normalizeMarkerComment = (contents) => {
    const replacedOpening = misc_1.getArrayInput('OPENING_COMMENT').reduce((acc, comment) => github_action_helper_1.Utils.replaceAll(acc, github_action_helper_1.Utils.getRegExp(comment), constant_1.OPENING_COMMENT), contents);
    return misc_1.getArrayInput('CLOSING_COMMENT').reduce((acc, comment) => github_action_helper_1.Utils.replaceAll(acc, github_action_helper_1.Utils.getRegExp(comment), constant_1.CLOSING_COMMENT), replacedOpening);
};

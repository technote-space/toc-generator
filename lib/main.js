...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (misc_1.isCreatePR(github_1.context)) {
                yield (new github_action_helper_1.ApiHelper(logger)).createPR(misc_1.getWorkDir(), misc_1.getCommitMessage(), files, misc_1.getPrBranchName(github_1.context), {
                    title: misc_1.getPrTitle(github_1.context),
                    body: misc_1.getPrBody(github_1.context, files),
                }, new github_1.GitHub(core_1.getInput('GITHUB_TOKEN', { required: true })), github_1.context);
            }
            else {

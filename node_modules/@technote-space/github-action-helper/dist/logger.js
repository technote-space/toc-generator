...
class Logger {
    ...
    constructor(replacer, notUseGroup = false) {
         ...
         */
        this.getColorString = (string, color, backColor, attribute) => sprintf_js_1.sprintf('\x1b[3%d;4%d;%dm%s\x1b[0m', COLOR_MAP[color], COLOR_MAP[(backColor !== null && backColor !== void 0 ? backColor : 'black')], ATTRIBUTE_MAP[(attribute !== null && attribute !== void 0 ? attribute : 'none')], string);
        /**
         * @param {string} string string
         * @param {Color} color color
         * @param {Color} backColor background color
         ...
         * @return {string} color string
         */
        this.c = (string, color, backColor, attribute) => this.getColorString(string, color, backColor, attribute);

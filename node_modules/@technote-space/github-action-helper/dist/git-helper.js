...
class GitHelper {
    ...
    constructor(logger, options) {
        ...
        this.getLastTag = (workDir) => __awaiter(this, void 0, void 0, function* () {
            ...
            return 'v' + (_u = (_t = tags.slice().sort(compareTag).reverse()[0]) === null || _t === void 0 ? void 0 : _t.replace(/^v/, ''), (_u !== null && _u !== void 0 ? _u : '0.0.0'));
        });
        /**
         * @param {string} workDir work dir
         * @return {string} tag

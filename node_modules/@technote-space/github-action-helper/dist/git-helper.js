...
class GitHelper {
    ...
    constructor(logger, options) {
        ...
        this.deleteTag = (workDir, tags, context, splitSize = 20) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.runCommand(workDir, utils_1.arrayChunk((typeof tags === 'string' ? [tags] : tags).map(getTagRef), splitSize).map(tags => ({
                command: 'git push',
            ...
            yield this.deleteLocalTag(workDir, tags, splitSize);
        });
        /**
         * @param {string} workDir work dir
         ...
         * @return {Promise<void>} void
         */
        this.deleteLocalTag = (workDir, tags, splitSize = 20) => __awaiter(this, void 0, void 0, function* () {
            const getTag = (tag) => tag.replace(/^(refs\/)?tags\//, '');
            yield this.runCommand(workDir, utils_1.arrayChunk((typeof tags === 'string' ? [tags] : tags).map(getTag), splitSize).map(tags => ({
                command: 'git tag',
                args: ['-d', ...tags],
                suppressError: this.shouldSuppressError(),
                stderrToStdout: true,

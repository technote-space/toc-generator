...
import { GitCreateTreeResponseData, GitCreateCommitResponseData, PullsListResponseData, PullsCreateResponseData, PullsUpdateResponseData } from '@octokit/types';
...
export default class ApiHelper {
     ...
     */
    filesToBlobs: (rootDir: string, files: Array<string>) => Promise<{
        path: string;
        sha: string;
    }[]>;
    /**
     ...
     */
    findPullRequest: (branchName: string) => Promise<PullsListResponseData[number] | null>;
    /**
     * @param {PullsListParams} params params
     * @return {AsyncIterable<PullsListResponseData>} pull request list
     */
    pullsList: (params: PullsListParams) => Promise<PullsListResponseData>;
    /**
     * @param {string} branchName branch name

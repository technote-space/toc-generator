...
export default class ApiHelper {
     ...
     */
    getRefForUpdate: (encode: boolean, octokit: GitHub, context: Context) => Promise<string>;
    /**
     ...
     */
    updateRef: (commit: Response<GitCreateCommitResponse>, refName: string, force: boolean, octokit: GitHub, context: Context) => Promise<boolean>;
    /**
     * @param {Response<GitCreateCommitResponse>} commit commit
     * @param {string} refName refName
     * @param {GitHub} octokit octokit
     ...
     * @return {Promise<void>} void
     */
    deleteRef: (refName: string, octokit: GitHub, context: Context) => Promise<void>;
    /**
     ...
     */
    pullsUpdate: (number: number, detail: PullsUpdateParams, octokit: GitHub, context: Context) => Promise<Response<PullsUpdateResponse>>;
    /**
     ...
     */
    createPR: (rootDir: string, commitMessage: string, files: string[], createBranchName: string, detail: PullsCreateParams, octokit: GitHub, context: Context) => Promise<boolean | PullsInfo>;
    /**
     * @param {string} createBranchName branch name
     * @param {GitHub} octokit octokit
     * @param {Context} context context
     ...
     */
    closePR: (createBranchName: string, octokit: GitHub, context: Context, message?: string | undefined) => Promise<void>;
    /**
     * @param {GitHub} octokit octokit
     * @param {Context} context context

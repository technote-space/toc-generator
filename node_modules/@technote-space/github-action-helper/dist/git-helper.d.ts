...
export default class GitHelper {
     ...
     * @return {Promise<{}[]>} void
     */
    runCommand: (workDir: string, commands: string | {
        command: string;
     ...
     * @return {Promise<void>} void
     */
    fetchOrigin: (workDir: string, context: Context) => Promise<void>;
    /**
     * @param {string} workDir work dir
     * @param {string} branch branch
     * @param {Context} context context
     ...
     */
    makeCommit: (workDir: string, message: string, count?: number) => Promise<void>;
    /**
     * @param {string} workDir work dir
     * @return {Promise<string[]>} tags
     */
    getTags: (workDir: string) => Promise<string[]>;
    /**
     * @param {string} workDir work dir
     * @param {Context} context context
     ...
     * @return {Promise<void>} void
     */
    push: (workDir: string, branch: string, withTag: boolean, context: Context) => Promise<void>;
    /**
     * @param {string} workDir work dir
     * @param {string} branch branch
     * @param {Context} context context

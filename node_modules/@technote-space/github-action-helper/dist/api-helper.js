...
class ApiHelper {
    ...
    constructor(logger, options) {
         ...
         */
        this.getBranch = (context) => this.branch ? this.branch : utils_1.getBranch(context);
        /**
         * @param {Context} context context
         ...
         */
        this.getRefForUpdate = (context) => this.refForUpdate ? this.refForUpdate : utils_1.getRefForUpdate(context);
        /**
         ...
         */
        this.isProtectedBranchError = (error) => {
        ...
        this.commit = (rootDir, commitMessage, files, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.updateRef(commit, octokit, context);

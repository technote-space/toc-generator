...
class ApiHelper {
    ...
    constructor(octokit, context, logger, options) {
         ...
         */
        this.getDefaultBranch = () => __awaiter(this, void 0, void 0, function* () { var _e, _f; return _f = (_e = this.context.payload.repository) === null || _e === void 0 ? void 0 : _e.default_branch, (_f !== null && _f !== void 0 ? _f : (yield this.octokit.repos.get(Object.assign({}, this.context.repo))).data.default_branch); });
        /**
         ...
         */
        this.getLastTag = () => __awaiter(this, void 0, void 0, function* () { var _g, _h; return 'v' + (_h = (_g = (yield this.getTags()).filter(tag => /^v?\d+(\.\d+)*$/.test(tag)).sort(utils_1.versionCompare).reverse()[0]) === null || _g === void 0 ? void 0 : _g.replace(/^v/, ''), (_h !== null && _h !== void 0 ? _h : '0.0.0')); });
        /**
         * @return {Promise<string>} tag
         */

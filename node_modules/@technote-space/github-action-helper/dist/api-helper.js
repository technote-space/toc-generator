...
class ApiHelper {
    ...
    constructor(octokit, context, logger, options) {
        ...
        this.getDefaultBranch = () => __awaiter(this, void 0, void 0, function* () { var _e, _f; return _f = (_e = this.context.payload.repository) === null || _e === void 0 ? void 0 : _e.default_branch, (_f !== null && _f !== void 0 ? _f : (yield this.octokit.repos.get({
            owner: this.context.repo.owner,
            repo: this.context.repo.repo,
        })).data.default_branch); });

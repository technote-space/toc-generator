...
class ApiHelper {
    ...
    constructor(logger, options) {
         ...
         */
        this.getRefForUpdate = (octokit, context) => __awaiter(this, void 0, void 0, function* () {
            return encodeURIComponent(this.refForUpdate ?
                this.refForUpdate : (utils_1.isPrRef(context) ? ('heads/' + (yield this.getPR(octokit, context)).data.head.ref) : utils_1.getRefForUpdate(context)));
        });
        /**
        ...
        this.getCommit = (octokit, context) => __awaiter(this, void 0, void 0, function* () {
            this.logger.warn(context.payload.after);
            this.logger.warn(context.ref);
            this.logger.warn(utils_1.isPrRef(context) ? '1' : '0');
            this.logger.warn(utils_1.isPrRef(context) ? context.payload.after : context.sha);
            return octokit.git.getCommit({
                owner: context.repo.owner,
                repo: context.repo.repo,
                'commit_sha': utils_1.isPrRef(context) ? context.payload.after : context.sha,
            });
        });
        /**
         * @param {GitHub} octokit octokit
        ...
        this.updateRef = (commit, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield octokit.git.updateRef({
                    owner: context.repo.owner,
                    repo: context.repo.repo,
                    ref: yield this.getRefForUpdate(octokit, context),
                    sha: commit.data.sha,
                });
                return true;
            }
        ...
        this.commit = (rootDir, commitMessage, files, octokit, context) => __awaiter(this, void 0, void 0, function* () {
            ...
            const commit = yield this.createCommit(commitMessage, tree, octokit, context);
            this.logger.startProcess('Updating ref... [%s] [%s]', yield this.getRefForUpdate(octokit, context), commit.data.sha);

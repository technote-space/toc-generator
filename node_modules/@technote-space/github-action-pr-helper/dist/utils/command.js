...
const getApiHelper = (octokit, context, logger, refForUpdate) => new github_action_helper_1.ApiHelper(octokit, context.actionContext, logger, { refForUpdate });
...
const config = (helper, logger, context) => __awaiter(void 0, void 0, void 0, function* () { return yield helper.config(getWorkspace(), variables_1.getCommitName(context), variables_1.getCommitEmail(context)); });
...
const resolveConflicts = (branchName, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield exports.merge(misc_1.getContextBranch(context), helper, logger, context)) {
        ...
        yield exports.getApiHelper(getOctokit(misc_1.getApiToken()), context, logger, misc_1.getPrBaseRef(context)).pullsCreateOrUpdate(branchName, {
            title: yield variables_1.getPrTitle(helper, octokit, context),
            body: yield variables_1.getPrBody(false, files, output, helper, octokit, context),
        });
    }
...
const getCurrentVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('current-version'), () => __awaiter(void 0, void 0, void 0, function* () { return yield exports.getApiHelper(octokit, context).getLastTag(); }), context); });
exports.getCurrentVersion = getCurrentVersion;
const getNewPatchVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-patch-version'), () => __awaiter(void 0, void 0, void 0, function* () { return yield exports.getApiHelper(octokit, context).getNewPatchVersion(); }), context); });
exports.getNewPatchVersion = getNewPatchVersion;
const getNewMinorVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-minor-version'), () => __awaiter(void 0, void 0, void 0, function* () { return yield exports.getApiHelper(octokit, context).getNewMinorVersion(); }), context); });
exports.getNewMinorVersion = getNewMinorVersion;
const getNewMajorVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-major-version'), () => __awaiter(void 0, void 0, void 0, function* () { return yield exports.getApiHelper(octokit, context).getNewMajorVersion(); }), context); });
exports.getNewMajorVersion = getNewMajorVersion;
const findPR = (branchName, octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('pr', { branchName }), () => __awaiter(void 0, void 0, void 0, function* () { return exports.getApiHelper(octokit, context).findPullRequest(branchName); }), context); });

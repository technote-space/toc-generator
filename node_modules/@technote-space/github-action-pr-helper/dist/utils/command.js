...
const userConfig = (helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    return yield helper.config(getWorkspace(), {
        name: variables_1.getCommitName(context),
        email: variables_1.getCommitEmail(context),
    });
});
exports.userConfig = userConfig;
const branchConfig = (helper, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return yield helper.config(getWorkspace(), {
        defaultBranch: yield exports.getDefaultBranch(octokit, context),
    });
});
...
const getRefDiff = (compare, helper, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (yield helper.getRefDiff(getWorkspace(), 'HEAD', compare, misc_1.getGitFilterStatus(context), '..'));
});
...
const merge = (branch, helper, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield exports.userConfig(helper, context);
...
const closePR = (branchName, logger, context, message) => __awaiter(void 0, void 0, void 0, function* () { return exports.getApiHelper(getOctokit(misc_1.getApiToken()), context, logger).closePR(branchName, message !== null && message !== void 0 ? message : context.actionDetail.prCloseMessage); });
...
const getDefaultBranch = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return misc_1.getCache(misc_1.getCacheKey('repos', {
        owner: context.actionContext.repo.owner,
        repo: context.actionContext.repo.repo,
    }), () => exports.getApiHelper(octokit, context).getDefaultBranch(), context);
});
exports.getDefaultBranch = getDefaultBranch;
const getCurrentVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('current-version'), () => exports.getApiHelper(octokit, context).getLastTag(), context); });
exports.getCurrentVersion = getCurrentVersion;
const getNewPatchVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-patch-version'), () => exports.getApiHelper(octokit, context).getNewPatchVersion(), context); });
exports.getNewPatchVersion = getNewPatchVersion;
const getNewMinorVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-minor-version'), () => exports.getApiHelper(octokit, context).getNewMinorVersion(), context); });
exports.getNewMinorVersion = getNewMinorVersion;
const getNewMajorVersion = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('new-major-version'), () => exports.getApiHelper(octokit, context).getNewMajorVersion(), context); });
exports.getNewMajorVersion = getNewMajorVersion;
const findPR = (branchName, octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('pr', { branchName }), () => exports.getApiHelper(octokit, context).findPullRequest(branchName), context); });

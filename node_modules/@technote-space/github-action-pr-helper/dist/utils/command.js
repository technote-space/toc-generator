...
exports.getChangedFilesForRebase = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield helper.cloneBranch(getWorkspace(), misc_1.getPrBaseRef(context), context.actionContext);
    yield helper.createBranch(getWorkspace(), yield variables_1.getPrBranchName(helper, octokit, context));
    return runCommands(helper, logger, context);
});
exports.closePR = (branchName, logger, octokit, context, message) => __awaiter(void 0, void 0, void 0, function* () { return exports.getApiHelper(getOctokit(misc_1.getApiToken()), context, logger).closePR(branchName, message !== null && message !== void 0 ? message : context.actionDetail.prCloseMessage); });

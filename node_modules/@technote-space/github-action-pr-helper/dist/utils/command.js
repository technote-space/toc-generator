...
const config = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return yield helper.config(getWorkspace(), variables_1.getCommitName(context), variables_1.getCommitEmail(context), yield exports.getDefaultBranch(octokit, context)); });
...
const clone = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield exports.config(helper, logger, octokit, context);
...
const merge = (branch, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
...
const commit = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    yield exports.config(helper, logger, octokit, context);
...
const isMergeable = (number, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return misc_1.getCache(misc_1.getCacheKey('pulls.get', {
        ...
        return ensureNotNullValue((yield octokit.pulls.get({
            owner: context.actionContext.repo.owner,
            repo: context.actionContext.repo.repo,
            'pull_number': number,
...
const getChangedFiles = (helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield exports.checkBranch(helper, logger, octokit, context)) {
        if (!(yield exports.merge(misc_1.getContextBranch(context), helper, logger, octokit, context))) {
...
const resolveConflicts = (branchName, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield exports.merge(misc_1.getContextBranch(context), helper, logger, octokit, context)) {
        ...
        yield exports.commit(helper, logger, octokit, context);

...
const { getWorkspace, useNpm, getBranch } = github_action_helper_1.Utils;
...
exports.updatePr = (branchName, files, output, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const apiHelper = exports.getApiHelper(logger);
    const pr = yield apiHelper.findPullRequest(branchName, octokit, context.actionContext);
    if (pr) {
        logger.startProcess('Creating comment to PullRequest... [%s] -> [%s]', getBranch(branchName, false), yield apiHelper.getRefForUpdate(false, octokit, context.actionContext));
        yield apiHelper.createCommentToPr(branchName, yield variables_1.getPrBody(true, files, output, helper, logger, octokit, context), octokit, context.actionContext);
        return exports.isMergeable(pr.number, octokit, context);
    }
    else {
        logger.startProcess('Creating PullRequest... [%s] -> [%s]', getBranch(branchName, false), yield apiHelper.getRefForUpdate(false, octokit, context.actionContext));
...
exports.findPR = (branchName, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return misc_1.getCache(misc_1.getCacheKey('pr', { branchName }), () => __awaiter(void 0, void 0, void 0, function* () { return exports.getApiHelper(logger).findPullRequest(branchName, octokit, context.actionContext); }), context); });

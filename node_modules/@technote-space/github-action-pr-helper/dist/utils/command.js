...
exports.updatePr = (branchName, files, output, helper, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const info = yield exports.getApiHelper(logger).pullsCreateOrComment(branchName, {
        title: yield variables_1.getPrTitle(helper, context),
        body: yield variables_1.getPrBody(files, output, helper, context),
...
exports.getChangedFilesForRebase = (helper, logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield helper.createBranch(getWorkspace(), yield variables_1.getPrBranchName(helper, context));
    return runCommands(helper, logger, context);
});
...
exports.getNewPatchVersion = (helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (!context.newPatchVersion) {
        // eslint-disable-next-line require-atomic-updates
        context.newPatchVersion = yield helper.getNewPatchVersion(getWorkspace());
    }

...
const runCreatePr = (isClose, getPulls, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _b = __asyncValues(getPulls(octokit, context)), _c; _c = yield _b.next(), !_c.done;) {
            ...
            const target = yield variables_1.getPrBranchName(helper, logger, octokit, context);
            if (target in processed && !misc_1.isActionPr(actionContext)) {
                results.push(getResult('skipped', `duplicated (${target})`, actionContext));
                continue;
            }
            try {
                results.push(yield createPr(true, isClose, helper, logger, octokit, actionContext));
            }
            catch (error) {

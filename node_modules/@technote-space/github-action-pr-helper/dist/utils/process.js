...
const getResult = (result, detail, context) => ({
    result,
    detail,
    branch: misc_1.getPrHeadRef(context) || getBranch(context.actionContext),
});
...
const runCreatePr = (isClose, getPulls, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _b = __asyncValues(getPulls(octokit, context)), _c; _c = yield _b.next(), !_c.done;) {
            ...
            try {
                results.push(yield createPr(true, isClose, logger, octokit, actionContext));
            }
            catch (error) {
...
exports.execute = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (misc_1.isClosePR(context)) {
        ...
        yield outputResult(yield createCommit(false, commonLogger, octokit, context), true);
    }

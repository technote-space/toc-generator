...
const createCommit = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const branchName = yield variables_1.getPrBranchName(helper, context);
...
const runCreatePr = (isClose, getPulls, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _b = __asyncValues(getPulls(octokit, context)), _c; _c = yield _b.next(), !_c.done;) {
            const pull = _c.value;
            try {
                results.push(yield createPr(true, isClose, logger, octokit, getActionContext(context, pull)));
            }
            catch (error) {

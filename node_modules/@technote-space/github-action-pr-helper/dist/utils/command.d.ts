...
export declare const getApiHelper: (octokit: GitHub, context: ActionContext, logger: Logger) => ApiHelper;
export declare const clone: (helper: GitHelper, logger: Logger, octokit: GitHub, context: ActionContext) => Promise<void>;
export declare const checkBranch: (helper: GitHelper, logger: Logger, octokit: GitHub, context: ActionContext) => Promise<boolean>;
...
export declare const getChangedFiles: (helper: GitHelper, logger: Logger, octokit: GitHub, context: ActionContext) => Promise<{
    files: string[];
    output: CommandOutput[];
}>;
export declare const getChangedFilesForRebase: (helper: GitHelper, logger: Logger, octokit: GitHub, context: ActionContext) => Promise<{
    files: string[];
    output: CommandOutput[];
}>;
...
export declare const getDefaultBranch: (octokit: GitHub, context: ActionContext) => Promise<string>;
export declare const getNewPatchVersion: (helper: GitHelper, context: ActionContext) => Promise<string>;
export declare const findPR: (branchName: string, logger: Logger, octokit: GitHub, context: ActionContext) => Promise<PullsListResponseItem | null | undefined>;

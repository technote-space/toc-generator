...
const contextVariables = (helper, context) => {
    ...
    return [
        ...
        { key: 'PR_NUMBER_REF', replace: getPrParamFunc(pr => pr.number ? `#${pr.number}` : misc_1.getDefaultBranchUrl(context)) },
        ...
        { key: 'PATCH_VERSION', replace: () => command_1.getNewPatchVersion(helper, context) },
...
exports.getPrBranchName = (helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    return isPush(context.actionContext) ?
        ...
        (misc_1.isActionPr(context) ? misc_1.getPrHeadRef(context) : (misc_1.isDefaultBranch(context) ?
            getPrBranchPrefixForDefaultBranch(context) + (yield replaceContextVariables(misc_1.getActionDetail('prBranchNameForDefaultBranch', context, () => misc_1.getActionDetail('prBranchName', context)), helper, context)) :
            getPrBranchPrefix(context) + (yield replaceContextVariables(misc_1.getActionDetail('prBranchName', context), helper, context))));
});
exports.getPrTitle = (helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    return yield replaceContextVariables((misc_1.isDefaultBranch(context) ?
        misc_1.getActionDetail('prTitleForDefaultBranch', context, () => misc_1.getActionDetail('prTitle', context)) :
        misc_1.getActionDetail('prTitle', context)).trim(), helper, context);
});
...
exports.getPrBody = (files, output, helper, context) => __awaiter(void 0, void 0, void 0, function* () {
    return replacePrBodyVariables((misc_1.isDefaultBranch(context) ?

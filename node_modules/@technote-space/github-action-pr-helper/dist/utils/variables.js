...
const contextVariables = (isComment, helper, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return [
        ...
        key: `VARIABLE${index + 1}`,
        replace: () => __awaiter(void 0, void 0, void 0, function* () { return getVariable(index, context); }),
    }))).concat([...Array((_d = (_c = context.actionDetail.prDateFormats) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0).keys()].map(index => ({
        // eslint-disable-next-line no-magic-numbers
        key: `DATE${index + 1}`,
        replace: () => __awaiter(void 0, void 0, void 0, function* () { return getDate(index, context); }),
    })));
});
/**
...
exports.getPrBranchName = (helper, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return isPush(context.actionContext) ?
        ...
        (misc_1.isActionPr(context) || misc_1.isNotCreatePR(context) ? misc_1.getPrHeadRef(context) : ((yield misc_1.isDefaultBranch(octokit, context)) ?

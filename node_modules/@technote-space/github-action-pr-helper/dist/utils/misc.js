...
exports.isDefaultBranch = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield command_1.getDefaultBranch(octokit, context)) === (context.isBatchProcess ? exports.getPrBaseRef(context) : getBranch(context.actionContext));
});
...
exports.getActionContext = (context, pull) => (Object.assign(Object.assign({}, context), { actionContext: Object.assign({}, context.actionContext, {
        payload: {
            'pull_request': {
                number: pull.number,
                id: pull.id,

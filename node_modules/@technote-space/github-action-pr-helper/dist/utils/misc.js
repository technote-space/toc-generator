...
const getDefaultBranchUrl = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return `https://github.com/${context.actionContext.repo.owner}/${context.actionContext.repo.repo}/tree/${yield command_1.getDefaultBranch(octokit, context)}`; });
...
const getPrBranchPrefixForDefaultBranch = (context) => context.actionDetail.prBranchPrefixForDefaultBranch || exports.getPrBranchPrefix(context);
exports.getPrBranchPrefixForDefaultBranch = getPrBranchPrefixForDefaultBranch;
const isActionPr = (context) => getPrefixRegExp(exports.getPrBranchPrefix(context)).test(exports.getPrHeadRef(context)) || getPrefixRegExp(exports.getPrBranchPrefixForDefaultBranch(context)).test(exports.getPrHeadRef(context));
exports.isActionPr = isActionPr;
const getContextBranch = (context) => context.isBatchProcess ? exports.getPrBaseRef(context) : (getBranch(context.actionContext) || exports.getPrHeadRef(context));
exports.getContextBranch = getContextBranch;
const isDefaultBranch = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return (yield command_1.getDefaultBranch(octokit, context)) === exports.getContextBranch(context); });
...
const isNotCreatePR = (context) => isPr(context.actionContext) && true === context.actionDetail.notCreatePr;
...
const ensureGetPulls = (pull, octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return pull !== null && pull !== void 0 ? pull : yield exports.getPullsArgsForDefaultBranch(octokit, context); });
...
const isSetApiToken = () => !!core_1.getInput('API_TOKEN');
exports.isSetApiToken = isSetApiToken;
const getApiToken = () => core_1.getInput('API_TOKEN') || getAccessToken(true);
exports.getApiToken = getApiToken;
const isActiveTriggerWorkflow = (context) => exports.isSetApiToken() && '' !== context.actionDetail.triggerWorkflowMessage;
...
const getAutoMergeThresholdDays = (context) => context.actionDetail.autoMergeThresholdDays && /^\d+$/.test(context.actionDetail.autoMergeThresholdDays) ? Number(context.actionDetail.autoMergeThresholdDays) : 0;

...
const isPassedAllChecks = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return !(yield octokit.paginate(octokit.rest.checks.listSuitesForRef.endpoint.merge(Object.assign(Object.assign({}, context.actionContext.repo), { ref: context.actionContext.sha })))).filter(suite => exports.checkSuiteState(checkSuiteId)(suite)).length;
});

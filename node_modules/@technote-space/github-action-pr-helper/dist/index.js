...
function main(option) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield misc_1.isTargetContext(octokit, yield getActionContext(option)))) {
            getLogger(option.logger).info((_a = option.notTargetEventMessage, (_a !== null && _a !== void 0 ? _a : 'This is not target event.')));
            return;
        }
...
function run(option) {
    /* istanbul ignore next */
    main(option).catch(error => { console.log(error); core_1.setFailed(error.message); });
}
exports.run = run;

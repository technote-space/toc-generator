...
const getLogger = (logger) => logger !== null && logger !== void 0 ? logger : new github_action_log_helper_1.Logger();
...
function main(option) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield (0, misc_1.isTargetContext)(octokit, yield getActionContext(option)))) {
            getLogger(option.logger).info((_a = option.notTargetEventMessage) !== null && _a !== void 0 ? _a : 'This is not a target event.');
            return;
        }
        yield (0, process_1.execute)(octokit, yield getActionContext(option));
    });
}
exports.main = main;
/* istanbul ignore next */

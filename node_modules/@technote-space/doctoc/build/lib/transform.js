...
const getHtmlHeaderContents = (headers, lowestRank, customTemplate, itemTemplate, separator) => utils_1.replaceVariables(customTemplate !== null && customTemplate !== void 0 ? customTemplate : __1.DEFAULT_HTML_TEMPLATE, [{
        key: 'ITEMS',
...
const transform = (content, { mode, moduleName, maxHeaderLevel, title, isNotitle, isFolding, entryPrefix, processAll, updateOnly, openingComment, closingComment, checkOpeningComments, checkClosingComments, isCustomMode, customTemplate, itemTemplate, separator, } = {}) => {

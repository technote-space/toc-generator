...
const addAnchor = (mode, moduleName, header) => {
    return Object.assign(Object.assign({}, header), { anchor: (0, anchor_markdown_header_1.anchor)(header.name, mode, header.repetition, moduleName), hash: (0, anchor_markdown_header_1.getUrlHash)(header.name, mode, header.repetition, moduleName) });
};
...
const countHeaders = (headers, mode, moduleName) => {
    ...
    return headers.map(header => {
        const name = (0, anchor_markdown_header_1.getUrlHash)(header.name, mode, undefined, moduleName);
...
const determineTitle = (title, isNotitle, isFolding, lines, info, startSection, matchesEnd) => {
    ...
    return wrapTitle((0, exports.getTitle)(title, lines, info, startSection, matchesEnd), isFolding);
};
...
const getHtmlHeaderContents = (headers, lowestRank, customTemplate, itemTemplate, separator) => (0, utils_1.replaceVariables)(customTemplate !== null && customTemplate !== void 0 ? customTemplate : __1.DEFAULT_CUSTOM_TEMPLATE, [{
        key: 'ITEMS',
...
const getHeaderItemHtml = (header, itemTemplate) => {
    return (0, utils_1.replaceVariables)(itemTemplate !== null && itemTemplate !== void 0 ? itemTemplate : __1.DEFAULT_ITEM_TEMPLATE, [
...
const transform = (content, options = {}) => {
    ...
    const info = update_section_1.default.parse(lines, (0, exports.matchesStart)(options.checkOpeningComments), (0, exports.matchesEnd)(options.checkClosingComments));
    const startSection = (0, params_1.getStartSection)(lines, info, (0, exports.matchesEnd)(options.checkClosingComments));
    const extractedOptions = (0, params_1.extractParams)(startSection.join(' '));
    ...
    const linesToToc = (0, exports.getLinesToToc)(lines, currentToc, info, processAll);
    const headers = (0, exports.getMarkdownHeaders)(linesToToc, maxHeaderLevel).concat((0, get_html_headers_1.getHtmlHeaders)(linesToToc, maxHeaderLevelHtml));
    headers.sort((header1, header2) => header1.line - header2.line);
    const allHeaders = (0, exports.countHeaders)(headers, _mode, moduleName);
    ...
    const inferredTitle = linkedHeaders.length ? determineTitle(title, isNotitle, isFolding, lines, info, startSection, (0, exports.matchesEnd)(options.checkClosingComments)) : '';
    ...
    const wrappedToc = (openingComment !== null && openingComment !== void 0 ? openingComment : __1.OPENING_COMMENT) + (0, params_1.getParamsSection)(extractedOptions) + '\n' + wrapToc(toc, inferredTitle, isFolding) + '\n' + (closingComment !== null && closingComment !== void 0 ? closingComment : __1.CLOSING_COMMENT);
    ...
    return getResult({
        transformed: true,
        result: {
            data: (0, update_section_1.default)(lines.join('\n'), wrappedToc, (0, exports.matchesStart)(options.checkOpeningComments), (0, exports.matchesEnd)(options.checkClosingComments), true),
            toc,
            wrappedToc,
        },
    });

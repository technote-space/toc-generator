...
const getHtmlHeaderContents = (headers, lowestRank, htmlTemplate, itemTemplate, separator) => utils_1.replaceVariables(htmlTemplate !== null && htmlTemplate !== void 0 ? htmlTemplate : __1.DEFAULT_HTML_TEMPLATE, [{
        key: 'ITEMS',
...
const transform = (content, { mode, moduleName, maxHeaderLevel, title, isNotitle, isFolding, entryPrefix, processAll, updateOnly, openingComment, closingComment, checkOpeningComments, checkClosingComments, isHtml, htmlTemplate, itemTemplate, separator, } = {}) => {
